            ...
            <form onSubmit={this.onSubmit} className="login-box bg-light br-3">
              <div className="row">
                <div className="col-12">
                  <div className="p-3">
                    <h1 className="font-weight-bold"> <img src={Logo} height="25" />Login</h1>
                    <p className="mb-0">Fill in the form to log into your account</p>
                    <hr className="mb-0" />
                  </div>
                </div>
                <div className="col-12">
              ...
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <a className="text-bold" href="#">Forgot password ?</a>
